...
public class PlayerData
{
    ...
    public void UpgradeLevel()
    {
        ...
        Health = MaxHealth;
        CreatePopup("LEVEL UP!", new Color(1f, 0.92f, 0));
    }

    public void AddGold(long gold)
    {
        this.Gold += gold;
        CreatePopup("+" + gold + " gold", new Color(1f, 0.92f, 0));
    }
    ...
    public void ReduceHealth(float damage)
    {
        ...
        // BISA MENGGUNAKAN CONSTANT BAWAAN DARI "Color"
        CreatePopup(((int)damage).ToString(), Color.red);
    ...
    public void AddExperience(long experience)
    {
        ...
        CreatePopup("+" + experience + " exp", new Color(0.03f, 0.85f, 0.98f));
    ...
    private void CreatePopup(string text, Color color)
    {
        PopUpGenerator.Instance.CreatePopup(Player.Instance.transform.position, text, color);
    }
}
